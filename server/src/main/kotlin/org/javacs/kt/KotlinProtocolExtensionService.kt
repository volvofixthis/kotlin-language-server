...
class KotlinProtocolExtensionService(
    ...
    override fun buildOutputLocation(): CompletableFuture<String?> =
        async.compute { cp.outputDirectory.absolutePath }

    override fun mainClass(
        textDocument: TextDocumentIdentifier
        ...
        async.compute {
            ...
            resolveMain(compiledFile) + mapOf("projectRoot" to workspacePath)
        }
